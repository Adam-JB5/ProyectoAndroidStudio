 ...
 */
public class ClienteSocketPartido {
    // 1. Conexion
    private String host;
    private int puerto;

    // Constructor
    public ClienteSocketPartido(String host, int puerto) {
        this.puerto = puerto;
        this.host = host;
    }
    ...
    public RespuestaPartido enviarPeticion(PeticionPartido peticion) {
        ...
        try {
            ...
            // Respuesta
            respuesta = (RespuestaPartido) ois.readObject();
