 ...
 */
public class ClienteSocketComentario {
    // 1. Conexion
    private String host;
    private int puerto;

    // Constructor
    public ClienteSocketComentario(String host, int puerto) {
        this.puerto = puerto;
        this.host = host;
    }
    ...
    public RespuestaComentario enviarPeticion(PeticionComentario peticion) {
        ...
        try {
            ...
            // Respuesta
            respuesta = (RespuestaComentario) ois.readObject();
