 ...
 */
public class ClienteSocketJugador {
    // 1. Conexion
    private String host;
    private int puerto;

    // Constructor
    public ClienteSocketJugador(String host, int puerto) {
        this.puerto = puerto;
        this.host = host;
    }
    ...
    public RespuestaJugador enviarPeticion(PeticionJugador peticion) {
        ...
        try {
            ...
            // Respuesta
            respuesta = (RespuestaJugador) ois.readObject();
