 ...
 */
public class ClienteSocketEventoPartido {
    // 1. Conexion
    private String host;
    private int puerto;

    // Constructor
    public ClienteSocketEventoPartido(String host, int puerto) {
        this.puerto = puerto;
        this.host = host;
    }
    ...
    public RespuestaEventoPartido enviarPeticion(PeticionEventoPartido peticion) {
        // Declarar las variables de conexion
        Socket socket = null;
        ObjectInputStream ois = null; // Recibimos
        ObjectOutputStream oos = null; // Enviamos
        RespuestaEventoPartido respuesta = null;
        ...
        try {
            ...
            // Respuesta
            respuesta = (RespuestaEventoPartido) ois.readObject();
