 ...
 */
public class ClienteSocketUsuarioEquiposSeguidos {
    // 1. Conexion
    private String host;
    private int puerto;

    // Constructor
    public ClienteSocketUsuarioEquiposSeguidos(String host, int puerto) {
        this.puerto = puerto;
        this.host = host;
    }
    ...
    public RespuestaUsuarioEquiposSeguidos enviarPeticion(PeticionUsuarioEquiposSeguidos peticion) {
        // Declarar las variables de conexion
        Socket socket = null;
        ObjectInputStream ois = null; // Recibimos
        ObjectOutputStream oos = null; // Enviamos
        RespuestaUsuarioEquiposSeguidos respuesta = null;
        ...
        try {
            ...
            // Respuesta
            respuesta = (RespuestaUsuarioEquiposSeguidos) ois.readObject();
