 ...
 */
public class ClienteSocketEquipo {
    // 1. Conexion
    private String host;
    private int puerto;

    // Constructor
    public ClienteSocketEquipo(String host, int puerto) {
        this.puerto = puerto;
        this.host = host;
    }
    ...
    public RespuestaEquipo enviarPeticion(PeticionEquipo peticion) {
        ...
        try {
            ...
            // Respuesta
            respuesta = (RespuestaEquipo) ois.readObject();
